class Horiz_Moving_Platform {
	...
	modify_attribute(attribute, parens_nums, parens_nums_string) {
		...
		switch(attribute) {
			...
			case "patrol_lines":
				...
				for(var count = 0; count < parens_nums.length; count++) {
					
					this.patrol_lines.push(new Horiz_Patrol_Line((parens_nums[count][0] + 1) * 20, parens_nums[count][1] * 20));
	...
	draw() {
		...
		screen.rect(this.x - you.x + you.spawn_x - screen.width, this.y - you.y + you.spawn_y - screen.height, 20, 20, "#30C0FF");
		screen.rect(this.x - you.x + you.spawn_x               , this.y - you.y + you.spawn_y - screen.height, 20, 20, "#30C0FF");
		screen.rect(this.x - you.x + you.spawn_x + screen.width, this.y - you.y + you.spawn_y - screen.height, 20, 20, "#30C0FF");
		screen.rect(this.x - you.x + you.spawn_x - screen.width, this.y - you.y + you.spawn_y                , 20, 20, "#30C0FF");
		screen.rect(this.x - you.x + you.spawn_x               , this.y - you.y + you.spawn_y                , 20, 20, "#30C0FF");
		screen.rect(this.x - you.x + you.spawn_x + screen.width, this.y - you.y + you.spawn_y                , 20, 20, "#30C0FF");
		screen.rect(this.x - you.x + you.spawn_x - screen.width, this.y - you.y + you.spawn_y + screen.height, 20, 20, "#30C0FF");
		screen.rect(this.x - you.x + you.spawn_x               , this.y - you.y + you.spawn_y + screen.height, 20, 20, "#30C0FF");
		screen.rect(this.x - you.x + you.spawn_x + screen.width, this.y - you.y + you.spawn_y + screen.height, 20, 20, "#30C0FF");
